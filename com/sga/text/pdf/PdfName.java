...
public class PdfName extends PdfObject implements Comparable<PdfName> {
	...
	//lkd
    public static final PdfName SGA_TCBL = new PdfName("SGA.TCBL");
    public static final PdfName SGA_TCVE = new PdfName("SGA.TCVE");
    
    public static final PdfName SGA_GPKI = new PdfName("SGA.GPKI");
    public static final PdfName SGA_NPKITS = new PdfName("SGA.TimeStamp");
    public static final PdfName SGA_GPKITS = new PdfName("GTSA TimeStamp");
    public static final PdfName GOV_GPKITS = new PdfName("Government Timestamp");
    
    //lkd
    public static final PdfName G4C = new PdfName("G4C");
    //lkd
    public static final PdfName sga_DRM = new PdfName("sgaDRM");
    //lkd
    public static final PdfName SGADRM = new PdfName("SGADRM");
    public static final PdfName SGACERT = new PdfName("SGACERT");
    public static final PdfName SGARESERVE = new PdfName("SGARESERVE");
    
    // pdfDigitalSign ����� ghpark
    public static final PdfName SGA_TSA = new PdfName("sgaTimeStamp");
    //자산관리공사 Papyrus ghpark
    public static final PdfName ePapyrus = new PdfName("ePapyrus.ThirdParty.ePapyrusSignature");
    // gov24 Unidocs ghpark
    public static final PdfName DreamSecurity = new PdfName("DreamSecurity.MagicVerify");
    /**
     * A name.
     * @since 2.1.6
     */
    ...
    public static final PdfName SGA_PKCS7_DETACHED = new PdfName("sga.pkcs7.detached");
    public static final PdfName SGA_PKCS7_SHA1 = new PdfName("sga.pkcs7.sha1");
    public static final PdfName GTSA_PKCS7_DETACHED = new PdfName("gtsa.pkcs7.detached");
    public static final PdfName GTSA_PKCS7_SHA1 = new PdfName("gtsa.pkcs7.sha1");
    
    //lkd
    public static final PdfName SGA_TCBL_SHA256 = new PdfName("sga.tcbl.sha256");
    public static final PdfName SGA_TCVE_SHA256 = new PdfName("sga.tcve.sha256");
    ...
    //lkd
    public static final PdfName EMBEDDEDFILESSGA = new PdfName("SGAEmbeddedFiles");
    /** A name */
     ...
     * @since	2.1.6
     */
    public static final PdfName SGA = new PdfName("SGA");
    /** A name */
    ...
    public static final PdfName POSBOX = new PdfName("PosBox");
    
    public static final PdfName EMBEDDEDFILESGA = new PdfName("SGAEmbeddedFile");
