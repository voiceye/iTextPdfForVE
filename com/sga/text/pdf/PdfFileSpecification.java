...
import com.sga.text.pdf.collection.PdfCollectionItem;
...
public class PdfFileSpecification extends PdfDictionary {
    ...
    public static PdfFileSpecification SGABarcodeEmbedded(PdfWriter writer, String filePath, String fileDisplay, byte fileStore[], String mimeType, PdfDictionary fileParameter, int compressionLevel, int pageNum, int[] posArray) throws IOException {
    	PdfFileSpecification fs = new PdfFileSpecification();
        fs.writer = writer;
        ...
        try {
            ...
            stream.put(PdfName.TYPE, PdfName.EMBEDDEDFILESGA);
            ...
            infoRef = writer.addToBody(stream).getIndirectReference(); 
            infoRef.setContent(new StringBuffer("[").append(pageNum).append(" "+posArray[0]).append(" "+posArray[1]).append(" "+posArray[2]+"]").toString());
        }
        finally {
            if (in != null)
