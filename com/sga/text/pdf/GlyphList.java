...
import com.sga.text.pdf.fonts.FontsResourceAnchor;
...
public class GlyphList {
    ...
    static {
        ...
        try {
            ...
            if (is == null) {
                String msg = "glyphlist.txt not found as resource. (It must exist as resource in the package com.sga.text.pdf.fonts)";
