...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setGrayFill(float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetGrayFill()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setGrayStroke(float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetGrayStroke()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setRGBColorFillF(float, float, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetRGBColorFill()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setRGBColorStrokeF(float, float, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetRGBColorStroke()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setCMYKColorFillF(float, float, float, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetCMYKColorFill()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setCMYKColorStrokeF(float, float, float, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#resetCMYKColorStroke()
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#addImage(com.sga.text.Image, float, float, float, float, float, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int, int)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setCMYKColorStroke(int, int, int, int)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setRGBColorFill(int, int, int)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setRGBColorStroke(int, int, int)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setColorStroke(com.sga.text.BaseColor)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setColorFill(com.sga.text.BaseColor)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setColorFill(com.sga.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setColorStroke(com.sga.text.pdf.PdfSpotColor, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setPatternFill(com.sga.text.pdf.PdfPatternPainter)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setPatternFill(com.sga.text.pdf.PdfPatternPainter, com.sga.text.BaseColor, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setPatternStroke(com.sga.text.pdf.PdfPatternPainter, com.sga.text.BaseColor, float)
     */
    ...
    /**
     * @see com.sga.text.pdf.PdfContentByte#setPatternStroke(com.sga.text.pdf.PdfPatternPainter)
     */
