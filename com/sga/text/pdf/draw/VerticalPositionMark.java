...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * @see com.sga.text.pdf.draw.DrawInterface#draw(com.sga.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
    ...
    /**
     * @see com.sga.text.Element#process(com.sga.text.ElementListener)
     */
    ...
    /**
     * @see com.sga.text.Element#getChunks()
     */
