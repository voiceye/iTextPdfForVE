...
import com.sga.text.exceptions.BadPasswordException;
import com.sga.text.pdf.AcroFields.Item;
...
import com.sga.text.xml.xmp.XmpReader;
...
class PdfStamperImp extends PdfWriter {
    ...
    void close(HashMap<String, String> moreInfo) throws IOException {
        ...
        pages.put(PdfName.SGA, new PdfString(Document.getRelease()));
        markUsed(pages);
...
//        reader.getCatalog().remove(PdfName.ACROFORM);
    ...
    /**
     * @see com.sga.text.pdf.PdfWriter#getPageReference(int)
     */
    @Override
    ...
    /**
     * @see com.sga.text.pdf.PdfWriter#addAnnotation(com.sga.text.pdf.PdfAnnotation)
     */
    @Override
    ...
    void addFileAttachments() throws IOException {
        HashMap<String, PdfObject> fs;
        if(pdf.getSGAFileAttachment())
        	fs = pdf.getDocumentFileAttachmentSGA();
        else
        	fs = pdf.getDocumentFileAttachment();
        if (fs.isEmpty())
            return;
        PdfDictionary catalog = reader.getCatalog();
        PdfDictionary names = (PdfDictionary)PdfReader.getPdfObject(catalog.get(PdfName.NAMES), catalog);
        ...
        if(pdf.getSGAFileAttachment())
        	names.put(PdfName.EMBEDDEDFILESSGA, addToBody(tree).getIndirectReference());
        else
        	names.put(PdfName.EMBEDDEDFILES, addToBody(tree).getIndirectReference());
    }
    ...
    /**
     * @see com.sga.text.pdf.PdfWriter#setOpenAction(com.sga.text.pdf.PdfAction)
     */
    @Override
    ...
    /**
     * @see com.sga.text.pdf.PdfWriter#setOpenAction(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.sga.text.pdf.PdfWriter#setThumbnail(com.sga.text.Image)
     */
    @Override
    public void setThumbnail(com.sga.text.Image image) {
