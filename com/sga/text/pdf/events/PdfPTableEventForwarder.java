...
import com.sga.text.pdf.PdfPTableEvent;
import com.sga.text.pdf.PdfPTableEventSplit;
...
public class PdfPTableEventForwarder implements PdfPTableEventSplit {
	...
	/**
	 * @see com.sga.text.pdf.PdfPTableEvent#tableLayout(com.sga.text.pdf.PdfPTable, float[][], float[], int, int, com.sga.text.pdf.PdfContentByte[])
	 */
    ...
    /**
     * @see com.sga.text.pdf.PdfPTableEventSplit#splitTable(com.sga.text.pdf.PdfPTable)
	 * @since iText 5.0.6
     */
