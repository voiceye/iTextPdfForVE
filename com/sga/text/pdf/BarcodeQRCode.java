...
import com.sga.text.pdf.qrcode.EncodeHintType;
import com.sga.text.pdf.qrcode.WriterException;
import com.sga.text.pdf.qrcode.ByteMatrix;
import com.sga.text.pdf.qrcode.QRCodeWriter;
import com.sga.text.BadElementException;
...
public class BarcodeQRCode {
    ...
    public BarcodeQRCode(String[] content, int width, int height, Map<EncodeHintType,Object> hints) {
        try {
            ...
            bm = qc.encode(data, width, height, hints);
        }
        catch (WriterException ex) {
            throw new ExceptionConverter(ex);
        }
