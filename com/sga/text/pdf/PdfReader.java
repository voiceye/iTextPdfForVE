...
import com.sga.text.exceptions.UnsupportedPdfException;
import com.sga.text.pdf.PRTokeniser.TokenType;
import com.sga.text.pdf.codec.TIFFConstants;
import com.sga.text.pdf.codec.TIFFFaxDecoder;
import com.sga.text.pdf.codec.TIFFFaxDecompressor;
...
public class PdfReader implements PdfViewerPreferences {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            strings.remove(o);
            s = o.toString();
            documentID = com.sga.text.DocWriter.getISOBytes(s);
        ...
        if (filter.equals(PdfName.STANDARD)) {
            ...
            uValue = com.sga.text.DocWriter.getISOBytes(s);
            s = enc.get(PdfName.O).toString();
            strings.remove(enc.get(PdfName.O));
            oValue = com.sga.text.DocWriter.getISOBytes(s);
                ...
                try {
                    ...
                    while (recipientCertificatesIt.hasNext()) {
                        ...
                        if (recipientInfo.getRID().match(certificate) && !foundRecipient) {
                         // ghpark [2022-03-10] envelopedData = recipientInfo.getContent(certificateKey, certificateKeyProvider);
