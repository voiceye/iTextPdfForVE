...
public class TrustCertificateVE {
	private String strLastErr;
	private	  boolean m_bDebug;
	private String m_logClass = "[Java TC VE] ";
	public TrustCertificateVE() {
		strLastErr = "";
		m_bDebug = false;
    }
	...
	public int ExecTCVE(String src, String dest, String tcbl_server, int tcbl_port, 
	    ...
	    try {
	        ...
	        sap.setRenderingMode(RenderingMode.VOICEYE);
	        ...
	        if(trailer.contains(PdfName.ID))
	        {
	            ...
	            //==================================================================
	            //저장할때 original 값이 변경된다. 수정 필요 =========================== 
	        }
	        
	        //request value
	        String request_value = doc_num + "|" + hash;
	        
	        //get blockchain token(등록)   ==> using blackchain restful
	    	...
	    	if(m_bDebug) {
				System.out.println(m_logClass + "ExecTCVE(82043) : Exception = " + e.getMessage());
	        }
	    	nRet = 82043;
