...
public class HTMLTagProcessors extends HashMap<String, HTMLTagProcessor> {
	...
	public static final HTMLTagProcessor EM_STRONG_STRIKE_SUP_SUP = new HTMLTagProcessor() {
		/**
		 * @see com.sga.text.html.simpleparser.HTMLTagProcessors#startElement(com.sga.text.html.simpleparser.HTMLWorker, java.lang.String)
		 */
		...
		/**
		 * @see com.sga.text.html.simpleparser.HTMLTagProcessors#endElement(com.sga.text.html.simpleparser.HTMLWorker, java.lang.String)
		 */
	...
	public static final HTMLTagProcessor BR = new HTMLTagProcessor(){
		/**
		 * @see com.sga.text.html.simpleparser.HTMLTagProcessors#startElement(com.sga.text.html.simpleparser.HTMLWorker, java.lang.String, java.util.Map)
		 */
		public void startElement(HTMLWorker worker, String tag, Map<String, String> attrs) {
			worker.newLine();
		}
