...
public class Document implements DocListener {
	...
	private static final String SGA_LIB = "SGA PDF Lib Ver:";
	private static final String RELEASE = "2.0.1.1";
	private static final String SGA_LIB_VERSION = SGA_LIB + " " + RELEASE;
